...
cloth.btn_create.addEventListener("click",function(){
    ...
    cloth.data_thigh = parseInt(document.getElementById("text_thigh").value);
    cloth.data_under = parseInt(document.getElementById("text_under").value);
    cloth.data_edge = parseInt(document.getElementById("text_edge").value);
    ...
    var point_cloth_bottom_right_x = point_cloth_bottom_center_x+cloth.data_edge;
    ...
    var point_thigh_x = point_start_x+cloth.data_thigh;
    var point_thigh_y = point_start_y+cloth.data_under;
    ...
    var point_front_under_y = point_front_waist_to_center_top_y+cloth.data_under;
